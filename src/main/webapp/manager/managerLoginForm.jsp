<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	...
	<script src="/doge-jsp/js/managerLogin.js"></script>
	<div class="form-container" id="loginContainer">
		<h2>로그인</h2>
		<form id="loginForm">
			<div class="input-group">
				<label for="id">사용자 이름</label> <input type="text" id="id" name="id" required>
			</div>
			<div class="input-group">
				<label for="pw">비밀번호</label> <input type="password" id="pw" name="pw" required>
			</div>
