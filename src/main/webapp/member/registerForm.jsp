...
<div class="form-container" id="registerContainer">
	...
	<form id="registerForm">
		<div class="input-group">
			<label for="id">사용자 이름</label> <input type="text"
				id="id" name="id" placeholder="4자 이상 16자 이하" required>
		</div>
		<div class="input-group">
			<label for="pw">비밀번호</label> <input type="password"
				id="pw" name="pw" placeholder="영문, 숫자, 특수문자를 포함한 8자 이상 16자 이하" required>
		</div>
		<div class="input-group">
			<label for="pwCheck">비밀번호 확인</label> <input type="password"
				id="pwCheck" name="pw" required>
		</div>
		<div class="input-group">
