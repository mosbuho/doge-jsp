...
<div class="purchase-form">
	...
	<div class="purchase-details">
		...
		<div class="right-column">
			<div class="product-name">
				<label for="goods_title">상품명 : </label> <span>${goods.title}</span>
			</div>
			<div class="quantity">
	...
	<div class="purchase-form-inputs">
		<label for="member_name">배송 받는 분</label> <input type="text"
		...
		<label for="name">카드 소유자 이름</label> <input type="text" id="name"
			...
			id="expiry_date" name="expiry_date" required><br> <label
