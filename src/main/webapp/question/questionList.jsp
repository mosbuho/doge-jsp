...
<div class="header">
	<h1>문의 내역</h1>
	<a href="/doge-jsp/updateMemberForm.do">내 정보</a> <a
		href="/doge-jsp/purchaseList.do">구매내역</a> <span>문의내역</span>
</div>
		...
		<div class="goods-group">
			<div class="goods-image">
				<a href="/doge-jsp/goodsContent.do?goods_id=${goodsEntry.key}">
					<img src="/doge-jsp/img/${goodsEntry.value[0].title_img}"
					alt="${goodsEntry.value[0].title}" />
				</a>
			</div>
