...
public class ManagerGoodsUpdateProcessAction implements CommandAction {
	@Override
	public String requestProcess(HttpServletRequest request, HttpServletResponse response) throws Throwable {
		if ((boolean) request.getSession().getAttribute("admin")) {
			...
			result = gdao.updateGoods(new GoodsBean(goods_id, title, description, uploadedImageName, price, discount,
					quantity, category));
